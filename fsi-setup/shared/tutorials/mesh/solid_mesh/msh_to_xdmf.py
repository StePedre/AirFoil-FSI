...
input_file = "NASAsc2-0410_10_deg_coarse.msh"
domain_output = "mesh_domain_10_deg_coarse.xdmf"
...
msh.points = msh.points / 1000.0 + np.array([0.0, 0.0488, 0.0]) # 0 deg
# msh.points = msh.points / 1000.0 + np.array([0.0, 0.1350, 0.0])   # 10 deg
